using Moq;
   ...
   namespace TaskPanelTest.ServiceTest
   {
       ...
       public class PanelServiceTests
       {
           ...
           [TestMethod]
           public void CreatePanel_ShouldThrowException_WhenPanelIsInvalid()
           {
               // Arrange
               ...
               // Act & Assert
               Assert.ThrowsException<NullReferenceException>(() => _panelService.CreatePanel(panel, 1));
           }
           ...
           public void DeletePanel_ShouldMarkAsDeleted_WhenPanelExists()
           {
               ...
               _mockTrashService.Verify(service => service.AddPanelToTrash(panel, user.TrashId), Times.Once);
           }
